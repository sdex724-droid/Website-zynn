...
<head>
  ...
  <title>QR Generator - Zynn V5</title>
  ...
  <style>
    ...
    * {
    ...
    .download-btn {
      ...
      width: 100%;
      padding: 14px;
      background: linear-gradient(135deg, #AD4AE7, #8a2be2);
      border: none;
      border-radius: 12px;
      color: white;
      font-weight: bold;
  ...
  <div class="sidebar" id="sidebar">
    <div class="sidebar-header">
      ...
      <div class="logo-container">
        ...
        <img src="https://i.top4top.io/p_3590b6bk90.jpg" class="logo" alt="Zynn V5 Logo">
      </div>
      <div class="app-title">Zynn V5</div>
      <div class="access-info"><b><i>QR Generator</i></b></div>
    </div>
    ...
    <ul class="nav-menu">
      ...
      <li class="nav-item"><a href="https://wa.me/6282185162549" class="nav-link"><i class="fab fa-whatsapp"></i>WhatsApp</a></li>
      ...
      <li class="nav-item"><a href="/qr-generator" class="nav-link active"><i class="fas fa-qrcode"></i>QR Generator</a></li>
  ...
  <div class="main-content">
    ...
    <div class="header">
      <div class="main-logo-container">
        ...
        <img src="https://i.top4top.io/p_3590b6bk90.jpg" class="main-logo" alt="DictiveCore Logo">
      </div>
      <div>
        <div class="main-app-title">Zynn V5</div>
        <div class="main-access-info"><b>Tools QR Generator</b></div>
      </div>
    </div>
    ...
    <div class="info-section">
      ...
      <div class="info-content">
        <h3>𝙔𝙖𝙣𝙜 𝙢𝙖𝙪 𝙗𝙪𝙜 𝙝𝙖𝙧𝙪𝙨 𝙗𝙮𝙬𝙖𝙣 𝙙𝙪𝙡𝙪 𝙨𝙖𝙢𝙖 𝙈𝙖𝙨 𝘼𝘿𝙀𝙉 𝙑5</h3>
    ...
    <div class="footer">
      © 2025 - DictiveCore by AiiSigma. All rights reserved.
    </div>
  </div>
...
<script>
  ...
  function generateQR() {
    ...
    const qrCodeContainer = document.getElementB
